                ...
                <div class="card-body px-0 pb-2">
                    <div class="row px-4 py-3">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <p class="text-muted">
                                {!! $event->link ? '<a href="'.$event->link.'" target="_blank" class="text-muted">Event Details</a>' : 'N/A' !!}
                            </p>
                        </div>
                    ...
                    <div class="d-flex justify-content-end px-4 pb-2">
                        <a href="{{ route('public.events.index') }}" class="btn btn-secondary me-2">Back to Events</a>
                        @auth
