...
@section('title', 'Edit Dream Film Project')
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Edit Dream Film Project: {{ $filmProject->title }}</h6>
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                    <form method="POST" action="{{ route('film_projects.update', $filmProject) }}" class="p-4">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn bg-gradient-primary">Update Dream Film Project</button>
                        </div>
                    </form>
                </div>
            </div>
