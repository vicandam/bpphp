        ...
        <div class="col-lg-8 col-md-10 mx-auto">
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <form method="POST" action="{{ route('events.store') }}" class="p-4">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="ticket_price" value="{{ old('ticket_price') }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-3">
                                <div class="form-check form-switch d-flex align-items-center mb-3">
                                    <input class="form-check-input" type="checkbox" id="is_movie_screening" name="is_movie_screening" value="1" {{ old('is_movie_screening') ? 'checked' : '' }}>
                                    <label class="form-check-label mb-0 ms-3" for="is_movie_screening">Movie Screening</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-check form-switch d-flex align-items-center mb-3">
                                    <input class="form-check-input" type="checkbox" id="is_concert" name="is_concert" value="1" {{ old('is_concert') ? 'checked' : '' }}>
                                    <label class="form-check-label mb-0 ms-3" for="is_concert">Concert</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-check form-switch d-flex align-items-center mb-3">
                                    <input class="form-check-input" type="checkbox" id="is_seminar_workshop" name="is_seminar_workshop" value="1" {{ old('is_seminar_workshop') ? 'checked' : '' }}>
                                    <label class="form-check-label mb-0 ms-3" for="is_seminar_workshop">Seminar/Workshop</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-check form-switch d-flex align-items-center mb-3">
                                    <input class="form-check-input" type="checkbox" id="is_other_event" name="is_other_event" value="1" {{ old('is_other_event') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="form-check form-switch d-flex align-items-center mb-3">
                                    <input class="form-check-input" type="checkbox" id="campaign" name="campaign" value="1" {{ old('campaign') ? 'checked' : '' }}>
