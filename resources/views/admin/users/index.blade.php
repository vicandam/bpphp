                        ...
                        @else
                            <table class="table align-items-center mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Membership</th>
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="{{ route('show.users', $user) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="View User Details">
                                                View Details
                                            </a>
                                        </td>
                                    </tr>
